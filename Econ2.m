...
% the explanation of the variables is the same as in Econ_PE1.m
...
for index = 1:T
    ...
    % we use quadprog as followed to minimize phi (with no constraints)
    p_t = quadprog(A,f,[],[],[],[],[],[]);
...
% save the data
save("PE2_c_var_1over3.mat",'r','c','pi','p','e0','D','G','C','e','t');
